...
- [x] Task: Define STT State Machine with LangGraph (a91324d)
    - [x] **Write Tests**: Verify graph transitions and state persistence.
    - [x] **Implement Feature**: Develop `app/graph.py` to orchestrate the sliding window transcription loop.
- [x] Task: Implement Sliding Window Transcription with Local Context
    - [x] **Write Tests**: Verify N-2 chunk context injection.
    - [x] **Implement Feature**: Implement the final transcription prompt and response parsing logic.
